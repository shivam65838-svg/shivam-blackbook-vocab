        ...
        <ScrollView contentContainerStyle={styles.contentContainer} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            ...
            <ThemedText type="default" themeColor="textSecondary" style={styles.description}>
              Review your strongest and weakest words with a modern revision planner.
            </ThemedText>
          </View>
          ...
          <View style={styles.analyticsCard}>            
            ...
            <View style={[styles.progressRow, { backgroundColor: theme.surface }]}>              
              {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((day, index) => (
                <View key={day} style={[styles.bar, { height: 60 - index * 5, backgroundColor: theme.accent }]} />
              ))}
            </View>
          </View>
